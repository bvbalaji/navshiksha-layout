      ...
      <Card>
            ...
            <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                ...
                >
                    ...
                    <div className="text-xs text-white-foreground">Create a text-based lesson with rich content</div>
                </Button>
                <Button
                ...
                >
                    ...
                    <div className="text-xs text-white-foreground">Create an assessment using question types</div>
                </Button>
                <Button
                ...
                >
                    ...
                    <div className="text-xs text-white-foreground">Upload or embed video content</div>
                </Button>
                <Button
                ...
                >
                    ...
                    <div className="text-xs text-white-foreground">Create tasks for students to complete</div>
                </Button>
                <Button
                ...
                >
                    ...
                    <div className="text-xs text-white-foreground">Start a discussion topic for your class</div>
                </Button>
                <Button
                ...
                >
                    ...
                    <div className="text-xs text-white-foreground">Add external resources and links</div>
                </Button>
            </CardContent>
        </Card>
